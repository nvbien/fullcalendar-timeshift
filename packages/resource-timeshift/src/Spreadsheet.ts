...
import { HeaderBodyLayout } from '@fullcalendar/timeshift'
...
export default class Spreadsheet extends Component<SpreadsheetProps> {
  ...
  render(props: SpreadsheetProps, context: ComponentContext) {
    ...
    this.renderCells(props.superHeaderText, props.superHeader2ndLine, props.superHeader3rdLine, props.colSpecs)
  }
  ...
  _renderCells(superHeaderText,superHeader2ndLine, superHeader3rdLine, colSpecs) {
    let colTags = this.renderColTags(colSpecs)

    this.header.receiveProps({
      superHeaderText: superHeaderText,
      superHeader2ndLine: superHeader2ndLine,
      superHeader3rdLine: superHeader3rdLine,
      colSpecs,
      colTags
    }, this.context)
