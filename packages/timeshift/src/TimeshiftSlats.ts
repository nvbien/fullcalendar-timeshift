...
export interface TimeshiftSlatsProps {
  dateProfile: DateProfile
  tDateProfile: TimeshiftDateProfile
}

export default class TimeshiftSlats extends Component<TimeshiftSlatsProps> {
  ...
  render(props: TimeshiftSlatsProps) {
  ...
  slatCellHtml(date, isEm, tDateProfile: TimeshiftDateProfile) {
