...
import TimeshiftLane from './TimeshiftLane'

export default class TimeshiftView extends View {
...
<td class="fc-time-area ` + theme.getClass('widgetContent') + `"></td> \
  ...
  applyScroll(scroll, isResize) {
    ...
    // TODO: repeat code as ResourceTimeshiftView::updateSize
